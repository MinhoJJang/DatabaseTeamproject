...
public class FollowDAO {
	...
	String sql_insert="insert into follow(member_id, following_id) values(?,?)"; // 팔로우하기 
	String sql_selectFollowings = "select distinct following_id from follow where member_id=?"; // 팔로잉 목록 불러오기
	String sql_selectFollowers = "select distinct member_id from follow where following_id=?"; // 팔로우 목록 불러오기 
	String sql_delete = "delete from follow where member_id=? and following_id=?"; // 팔로우 취소
