            ...
            <div class="wrap">
                ...
                <div class="content">
                    ...
                    <div id="slideshow">
                        <div class="one">
                            ...
                            <p>Sign In and see what E1I3 have done!</p>
                        </div>
                ...
                <div class="user">
                    ...
                    <div class="form-wrap">
                        <!-- TABS -->
                      <div class="tabs">
                        <h3 class="login-tab"><a class="log-in active" href="#login-tab-content"><span>Sign In</span></a></h3>
                        <h3 class="signup-tab"><a class="sign-up" href="signup.jsp"><span>Sign Up</span></a></h3>
                      </div>
                        <!-- TABS CONTENT -->
                      <div class="tabs-content">
                            <!-- TABS CONTENT LOGIN -->
                        <div id="login-tab-content" class="active">
                          <form class="login-form" action="controller.jsp?action=login" method="post">
                            <input type="text" class="input" name="member_id" autocomplete="off" placeholder="ID">
                            <input type="password" class="input" name="member_pw" autocomplete="off" placeholder="Password">                                                 
