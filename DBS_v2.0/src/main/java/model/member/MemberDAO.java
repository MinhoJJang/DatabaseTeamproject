...
public class MemberDAO {
	...
	String sql_selectName="select member_name from member where member_id = ?";
	...
	public boolean updateM(MemberVO vo, String origin_member_name) {
		...
		// String sql_update="update member set member_pw=?, member_name=?, member_email=? where member_id=?";
		String sql_updatePost = "update post set member_name=? where member_name=?";
